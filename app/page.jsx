...
export default function HomePage() {
    ...
    <div>
      ...
      <p className="text-yellow-900 text-xs">Ready to book your next mascot?</p>
          ...
          <div className="flex items-center justify-center gap-6 py-12">
            <div className="w-44 h-64 flex-shrink-0 overflow-hidden rounded-xl">
  <img
    src="https://qyptjphqesakvegkgekx.supabase.co/storage/v1/object/public/images/hero-left.avif"
    alt="Mascot Left"
  ...
  />
            ...
            <div className="w-44 h-64 flex-shrink-0 overflow-hidden rounded-xl">
  <img
    src="https://qyptjphqesakvegkgekx.supabase.co/storage/v1/object/public/images/hero-right.avif"
    alt="Mascot Right"
    className="w-full h-full object-cover"
  />
</div>
